/* ============================================================
   VARAD SEEDS — Products JavaScript (products.js)
   Only loaded on products.html
   Contains: category filter, search, all variety data, all catalog functions
   ============================================================ */
...
function chilliImg(src) {
    return src && src.startsWith("assets/") ? src : "assets/images/site/chilli-fallback.jpg";
}
